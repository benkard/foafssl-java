...
$ cwm  serverDB.CACert.n3 ont.n3 http://www.w3.org/2000/10/swap/test/owl/owl-rules.n3 --think --solve=ca.goal.n3
     @prefix : <proof1.n3#> .
...
$ cwm  serverDB.CACert.n3 ont.n3 http://www.w3.org/2000/10/swap/test/owl/owl-rules.n3 --think --solve=ca.goal.n3 --why > out.n3

For more information about what the reasoner ends up knowning about client see

$ cwm  serverDB.CACert.n3 ont.n3 http://www.w3.org/2000/10/swap/test/owl/owl-rules.n3 --think --solve=ca.goal.intermediate.n3
